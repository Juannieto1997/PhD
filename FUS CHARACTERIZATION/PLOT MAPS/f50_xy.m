...
%% Paramètres
cd('D:\MUTATION\manips\proto v1 Champs de pression Puissance et impédance\Champs de Pression\TETE1\jeudi 21\focale 50\f50_xy');
fileformat = 'scanTestY%03dX%03d.txt';
focal = 50;

% nombre de lignes et colonnes acquises
n_row = 51; % <-- deuxieme variable
