...
dxf_domains_dir ='.\PARIS SETUP\'; % Data for the different medium
...
tx_freq = 2.25e6;              % Hz
tx_emitted_ac_power = 0.82;   % W -> I went with a ridiculously high value just so that you can see clear temperature elevation a 1MHz
FUS_on_time = 200e-6;       % (BHTE) set source on time -> Pulse duration [s]
