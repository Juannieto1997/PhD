...
% NOTE: Selects one channel and does a sigle deteccion and applies the cut
% to all the other channels, much faster than the previous version, might
% require manual imputs for validation. 
% FOR MANUAL VALIDATION
% 1. Open function f_detectPeaks and place a debugpoint in line 59 
% 2. Run p_ManualCorrectionAid for visualization and modify the first
% 3. Continue with the code 
% TODO: Improve the channel selecction
% TODO: validate the peak detection important for FUS 
...
v_FiltFreq = [1000 2500]; % Frequency to filter for peak detection
